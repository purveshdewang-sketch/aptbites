...
export default function Checkout() {
  ...
  const upiPaymentParams =
    new URLSearchParams({
      ...
      am: upiPaymentAmount,
      cu: "INR",
      tn: `NeFo food order ₹${upiPaymentAmount}`,
    });

  const upiPaymentLink =
    `upi://pay?${upiPaymentParams.toString()}`;
          ...
          >
            ...
            <div className="mt-4 rounded-2xl border border-[#D8C9B3] bg-[#FFFDF7] p-4">
              ...
              <p className="mt-3 text-[10px] font-semibold leading-relaxed text-[#6B6258]">
                Pay via UPI App and Scan QR will open with the current order amount.
                If any UPI app does not fill it automatically, enter exactly this same
                amount manually and upload only the Completed screenshot.
              </p>
            </div>
